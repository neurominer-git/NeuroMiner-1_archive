function [opt_hE, opt_E, opt_F, opt_Fcat, opt_D, opt_Pred] = nk_MultiDiversityMax(E, L, EnsStrat, C)
global BATCH
        ...
        while ksum > 0
            ...
            for curclass = 1:nclass
                ...
                while l > 0
                    ...
                    lD(l) = nk_Diversity(lT(:,lC==curclass),L, m);
                    l=l-1;
                end
