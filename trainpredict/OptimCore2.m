...
% or wrappers (via FoldPerm2). This includes ensemble-based optimization 
% strategies. Furthermore, it collects the CV1 training and CV1 test results 
% across the CV1 partitions and organizes them.
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%(c) Nikolaos Koutsouleris, 09/2017

function Res = OptimCore2(IN, OUT, strout, Param, OptMode, Weighting)
