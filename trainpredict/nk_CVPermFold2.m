function [PerfPermFoldCV, PerfPermFoldTS, models] = nk_CVPermFold2(Y, nclass, Ps, FilterSubSets, batchflag)
% =========================================================================
...
for curlabel=1:nl
    ...
    tPerfPermFoldCV = nk_TrainPermFold2(Y, nclass, Ps, FilterSubSets{curlabel}, batchflag);
