...
function [class_membership_probabilities class_recognition_accuracy] = predict_mRVM_MKL(TRAIN_OBJECT,Xtest_collection,test_labels,Xtrain_collection)
...
for s=1:TRAIN_OBJECT.sources
    if TRAIN_OBJECT.standardize_flag{s}
        ...
        Xtest_collection_standardized{s} = standardize_test_set(Xtest_collection{s},Xtrain_collection{s});
    else
