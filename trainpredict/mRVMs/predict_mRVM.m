...
function [class_membership_probabilities class_recognition_accuracy] = predict_mRVM(TRAIN_OBJECT,Xtest,test_labels,Xtrain_original)
if TRAIN_OBJECT.standardize_flag
    % standardize test set
    %Xtest = standardize_test_set(Xtest,TRAIN_OBJECT.X_prototypical);
    Xtest = standardize_test_set(Xtest,Xtrain_original);
    % test kernel
