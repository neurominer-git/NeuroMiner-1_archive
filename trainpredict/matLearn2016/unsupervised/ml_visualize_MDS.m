function [z] = ml_visualize_MDS(X, options)
% ml_visualize_MDS(X,options)
%
% Description:
%	 - Reduce dimensionality of X by minimizing squared difference in 
%       distances between pairs of points in original and reduced 
%       dimensional spaces. 
%
% Options:
...
optOptions = struct('display', 0);
z(:) = minFunc(@stress,z(:),optOptions,D);
