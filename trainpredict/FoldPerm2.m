%================================================================================
% [IN, OUT] = FoldPerm(IN, OUT, strout, fRFE, FullPartflag, kxFlag, LoopParam)
%================================================================================
% MAIN TRAINING MODULE
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%(c) Nikolaos Koutsouleris, 01/2019

function [IN, OUT] = FoldPerm2(IN, OUT, strout, fRFE, FullPartflag, RetrainImmediate, kxFlag, LoopParam)
...
%       -----------------------------------------------------------------------------
        for ccurclass=1:ClassNum 
            ...
            if kxFlag, kx = ceil((lFea(curclass) / 100) * kxFlag); end
        ...
        if fMULTI && fRFE
            ...
            for kT=1:kFea(curclass)
                ...
                for ccurclass=1:ClassNum 
                    ...
                    OUT = getperf2out(OUT, model, Ymodel, Ytrain, tTrL, Ytest, tCVL, FullPartflag, RetrainImmediate, cvts_fl, i, j, curclass, indkX, k);
                    ...
                    OUT = assign2out( OUT, RetrainImmediate, FullPartflag, cvts_fl, i , j, curclass);
...
function [OUT, IN, Ytrain, Ytest, Ymodel] = assignRF2data(OUT, RF, IN, Ytrain, Ytest, Ymodel, Fx, i, j, curclass, k, indkX, v)
...
function OUT = getperf2out(OUT, model, Ymodel, Ytrain, tTrL, Ytest, tCVL, FullPartflag, RetrainImmediate, cvts_fl, i, j, curclass, indkX, k)
global VERBOSE
