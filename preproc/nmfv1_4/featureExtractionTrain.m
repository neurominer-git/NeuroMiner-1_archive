...
switch feMethod
    ...
    case 'nmf'
        ...
        [A,trainExtr, out.Iter, out.tElapsed, out.FitRes] = nmfnnls(trainSet,opt.facts,opt.option);
        out.feMethod=feMethod;
    ...
    case 'sparsenmf'
        ...
        %         optionDefault.option=[];
        %         opt=mergeOption(opt,optionDefault);
        [A,trainExtr, out.Iter, out.tElapsed, out.FitRes] = sparsenmfnnls(trainSet,opt.facts,opt.option);
        out.feMethod=feMethod;
        out.factors={A;trainExtr};
        out.facts=opt.facts;
        out.optionTr=opt.option;
    case 'orthnmf'
        ...
        %         optionDefault.option=[];
        %         opt=mergeOption(opt,optionDefault);
        [A,S,trainExtr, tElapsed, FitRes]=orthnmfrule(trainSet,opt.facts,opt.option);
        out.feMethod=feMethod;
