function [eigvector, eigvalue, elapse] = MMP(gnd,feaLabel,feaUnlabel,options)
% MMP: Maximum Margin Projection
%      Semi-supervised version of LSDA (Locality Sensitive Discriminant Analysis)
%
%       [eigvector, eigvalue, elapse] = MMP(gnd,feaLabel,feaUnlabel,options)
% 
%             Input:
%               gnd     - Label vector.  
%
...
[Ww, timeW] = constructW(data,options.WOptions);
