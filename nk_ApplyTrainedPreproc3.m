function [ inp, contfl, analysis, mapY, GD, MD, Param, P, mapYocv ] = nk_ApplyTrainedPreproc3(analysis, inp, paramfl)
% =========================================================================
...
if smoothonly
    ...
    if isfield(inp,'saveparam') && inp.saveparam
        ...
        OptPreprocParamFilename = ...
            nk_GenerateNMFilePath( inp.procdir, SAV.matname, 'OptPreprocParam', [], inp.varstr, inp.id, CV2p , CV2f, CV1p, CV1f);
